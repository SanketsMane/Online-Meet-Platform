...
describe('test-OpenRedirect', function () {
    ...
    it('should handle query parameters correctly', function () {
        req.path = '/join/';
        req.url =
            '/join/?room=test&roomPassword=0&name=kidokoolsfu&audio=1&video=1&screen=0&hide=0&notify=1&duration=00:00:30';
    ...
    it('should handle query parameters with token', function () {
        req.path = '/join/';
        req.url =
            '/join/?room=test&roomPassword=0&name=kidokoolsfu&audio=1&video=1&screen=0&hide=0&notify=0&token=token';
