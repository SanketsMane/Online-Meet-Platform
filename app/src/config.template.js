...
module.exports = {
    ...
    media: {
         ...
         * Server Management
         * ----------------
         * NodeMediaServer (kidokool/nms:latest):
         *   - Start: npm run nms-start
         *   - Stop:  npm run nms-stop
         *   - Logs:  npm run nms-logs
         *
         * NGINX-RTMP (kidokool/rtmp:latest):
         ...
         * Documentation:
         * --------------
         * - https://docs.kidokool.com/kidokool-sfu/rtmp/
         */
        rtmp: {
    ...
    security: {
         ...
         */
        jwt: {
            key: process.env.JWT_SECRET || 'kidokoolsfu_jwt_secret',
        ...
        oidc: {
            ...
            config: {
                ...
                secret: process.env.OIDC_SECRET || 'kidokoolsfu-oidc-secret',
        ...
        host: {
            ...
            users_api_secret_key: process.env.USERS_API_SECRET || 'kidokoolweb_default_secret',
            users_api_endpoint: process.env.USERS_API_ENDPOINT || 'http://localhost:9000/api/v1/user/isAuth', // 'https://webrtc.kidokool.com/api/v1/user/isAuth'
            users_api_room_allowed:
                process.env.USERS_ROOM_ALLOWED_ENDPOINT || 'http://localhost:9000/api/v1/user/isRoomAllowed', // 'https://webrtc.kidokool.com/api/v1/user/isRoomAllowed'
            users_api_rooms_allowed:
                process.env.USERS_ROOMS_ALLOWED_ENDPOINT || 'http://localhost:9000/api/v1/user/roomsAllowed', // 'https://webrtc.kidokool.com/api/v1/user/roomsAllowed'
            api_room_exists: process.env.ROOM_EXISTS_ENDPOINT || 'http://localhost:9000/api/v1/room/exists', // 'https://webrtc.kidokool.com//api/v1/room/exists'
     ...
     * API Documentation:
     * ------------------
     * - Complete API reference: https://docs.kidokool.com/kidokool-sfu/api/
     * - Webhook setup: See integration guides for Slack/Mattermost
     */
    api: {
        keySecret: process.env.API_KEY_SECRET || 'kidokoolsfu_default_secret',
        allowed: {
    ...
    integrations: {
         ...
         *                (default: Streaming avatar instructions for Kidokool SFU)
         */
        videoAI: {
            enabled: process.env.VIDEOAI_ENABLED === 'true',
            basePath: 'https://api.heygen.com',
            apiKey: process.env.VIDEOAI_API_KEY || '',
            systemLimit: process.env.VIDEOAI_SYSTEM_LIMIT || 'You are a streaming avatar from Kidokool SFU...',
        },
            ...
            commands: [
                {
                    ...
                    baseUrl: process.env.DISCORD_BASE_URL || 'https://sfu.kidokool.com/join/',
                },
            ],
        },
         ...
         *      - Project demo: /kidokoolsfu/webhook/ folder
         */
        webhook: {
         ...
         *    - Click "Create bucket"
         *    - Choose unique name (e.g., 'kidokool')
        ...
        s3: {
            ...
            bucket: process.env.S3_BUCKET || 'kidokool',
    ...
    ui: {
         ...
         * LICENSE REQUIRED:
         * ==============================================
         * - https://codecanyon.net/item/kidokool-sfu-webrtc-realtime-video-conferences/40769970
         */
        rooms: {
            /**
             ...
             *   https://sfu.kidokool.com/activeRooms
             */
     ...
     * ==============================
     * Core WebRTC components powering Kidokool SFU
     *
     * Essential Links:
     * ---------------
