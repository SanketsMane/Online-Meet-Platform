...
This example shows how to set up a server to listen for Kidokool SFU webhook events (join, exitRoom, disconnect).
...
Kidokool SFU sends HTTP `POST` requests to the specified URL with event data:
